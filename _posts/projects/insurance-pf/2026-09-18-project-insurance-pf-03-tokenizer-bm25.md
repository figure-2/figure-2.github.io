...
처음에는 Kiwi가 보험 용어를 가장 잘 처리할 것으로 예상했다. 긴 복합명사를 보존하고 사용자 사전을 붙이기 쉬웠기 때문이다. 30개 FAQ를 검색해보니 Mecab이 더 높은 순위에 정답을 올렸고 인덱싱도 빨랐다.

예상과 결과가 달랐던 첫 실험이었다.

## 세 토크나이저는 서로 다른 표현에서 강했다

Kiwi, Mecab, Okt를 법률 용어, 복합명사, 숫자, 구어체 문장으로 비교했다.
