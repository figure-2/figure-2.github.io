---
title: "Git 기초"
excerpt: "Git 버전 관리 시스템의 기본 개념과 사용법"
...
permalink: /object-oriented/git-기초/
...
![DVCS](./assets/images/posts_img/distributed.png)

## 세가지 상태

![areas](./assets/mages/posts_img/areas.png)
...
3. git init
![master](./assets/mages/posts_img/git_init.png)
    - 현재 폴더에 `.git` 폴더를 생성
    - .git directory를 만든 것
    - **최초로 한 번 설정**
4. git add .
...
5. git commit -m "git 개념 추가"
    ...
    -![commit_message](./assets/mages/posts_img/commit_message.png)

6. git remote add origin https://github.com/dudns1234/TIL.git
    - remote : 원격 저장소를 관리하는 명령어 
    - 주소는 나의 github에 새로운 repository를 만든다.
    - ![create_repository](./assets/mages/posts_img/create_repository.png)
    - ![url](./assets/url.png)
    - ![repository_확인](./assets/mages/posts_img/repository_생성확인.png)
    - **최초로 한 번 설정**
