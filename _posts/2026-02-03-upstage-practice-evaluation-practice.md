...
## 실습 목표
에이전트 평가(Evaluation)와 AgentOps 모니터링 실습.

## 핵심 학습 포인트
- LLM-as-Judge 평가 기법
- 에이전트 성능 메트릭 정의
- AgentOps를 통한 운영 모니터링

## 진행 순서

1. `Evaluation + AgentOps 실습`에서 확인할 핵심 개념을 먼저 정리한다.
