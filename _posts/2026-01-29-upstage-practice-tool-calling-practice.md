...
## 실습 목표
Tool Calling 기본 개념과 MCP 활용 실습.

## 핵심 학습 포인트
- Function Calling 인터페이스 구현
- 도구 스키마 정의와 등록
- MCP 프로토콜 이해

## 진행 순서

1. `Tool Calling 기본 과제`에서 확인할 핵심 개념을 먼저 정리한다.
...
## 관련 개념
- Tool-Calling · MCP · W06D02-Tool-Calling-MCP
