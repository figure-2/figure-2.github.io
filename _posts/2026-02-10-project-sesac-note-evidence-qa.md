---
title: "단순 챗봇이 아니라 영상 근거 안에서 답하는 QA 흐름 만들기"
categories:
- 2.PROJECT
- 2-5. SeSAC-Note
tags:
...
- RAG
toc: true
date: 2026-02-10 09:50:00 +0900
comments: true
mermaid: true
math: true
---

# 단순 챗봇이 아니라 영상 근거 안에서 답하는 QA 흐름 만들기
...
- 이전 글: [긴 영상 처리에서 상태 추적과 체감 대기시간을 다룬 방법]({% post_url 2026-02-10-project-sesac-note-async-pipeline %})
- 다음 글: [LLM Judge로 요약 품질을 점검할 때 조심해야 할 것]({% post_url 2026-02-10-project-sesac-note-judge-evaluation %})
