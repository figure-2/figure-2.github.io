...
> **핵심 개념** BST 성능은 "높이(height)"가 결정한다
...
![트리, 그래프, DFS/BFS 탐색 다이어그램 1](/assets/images/upstage-ai-agent/diagrams/01-modules-data-structure-algorithm-w02d03-tree-graph-search-diagram-1.svg)
