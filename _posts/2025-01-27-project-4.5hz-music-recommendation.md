...
```mermaid
graph TB
    A[Spotify API] --> B[Data Collection]
    B --> C[Data Preprocessing]
    C --> D[ML Model Training]
    D --> E[Django Web Service]
    
    F[User Interaction] --> G[Kafka Producer]
    G --> H[Spark Streaming]
    H --> I[MongoDB]
    I --> J[Airflow Pipeline]
    J --> K[MySQL]
    K --> E
...
**GitHub Repository**: [4.5HZ Project](https://github.com/figure-2/MULTI_PJT2_4.5HZ)  
**데모 영상**: [YouTube 시연 영상](https://www.youtube.com/watch?v=Qgy6noP63Cg)  
**발표 자료**: [프로젝트 발표 PDF](https://github.com/figure-2/MULTI_PJT2_4.5HZ/blob/master/6.%20Project%20Results/(D29)_4.5HZ_%EB%B0%9C%ED%91%9C%EC%9E%90%EB%A3%8C.pdf)
