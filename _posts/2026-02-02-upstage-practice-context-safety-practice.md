---
title: "Context Engineering + Safety 실습"
categories:
- 1.TIL
...
## 실습 목표
Context Engineering 2.0과 Safety/Guardrails 실습.

## 핵심 학습 포인트
- 컨텍스트 윈도우 최적화 전략
- Safety guardrails 구현
- Prompt Injection 방어 기법

## 진행 순서

1. `Context Engineering + Safety 실습`에서 확인할 핵심 개념을 먼저 정리한다.
