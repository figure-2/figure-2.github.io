---
title: "Git 고급"
excerpt: "Git 협업, 브랜치, 포크 등 고급 기능 사용법"
...
permalink: /object-oriented/git-고급/
...
![remote_url](./assets/mages/posts_img/remote_url.png)
...
![협업](./assets/mages/posts_img/협업관련.png)
...
- if 충돌이 발생한 경우 (=pull을 진행하지 않고 push한 경우)
    -VScode 선택하여 해결
        - 3가지 방법 중에서 한 가지 선택
        ![충돌해결](./assets/mages/posts_img/3가지선택.png)
...
- create fork 진행
![fork](./assets/mages/posts_img/fork.png)
